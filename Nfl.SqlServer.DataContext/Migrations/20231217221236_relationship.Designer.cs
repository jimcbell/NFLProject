...
namespace Nfl.SqlServer.DataContext.Migrations
{
    ...
    [Migration("20231217221236_relationship")]
            ...
            modelBuilder.Entity("NFL.SqlServer.DataContext.Entities.NflPlay", b =>
                {
                    ...
                    b.Property<int?>("NflPlayTypePlayTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NflPlayTypePlayTypeId");
            ...
            modelBuilder.Entity("Nfl.SqlServer.DataContext.Entities.NflPlayType", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlayTypeId"));
            ...
            modelBuilder.Entity("NFL.SqlServer.DataContext.Entities.NflPlay", b =>
                {
                    b.HasOne("Nfl.SqlServer.DataContext.Entities.NflPlayType", "NflPlayType")
                        .WithMany("NflPlays")
                        .HasForeignKey("NflPlayTypePlayTypeId");
